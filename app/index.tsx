		...
		<Animated.View entering={FadeIn} style={styles.content}>
			<View style={styles.headerContainer}>
				<Text style={styles.title}>
					Manage{"\n"}your{"\n"}finances{" "}
					<Text style={styles.highlight}>simply</Text>
				</Text>
				<Text style={styles.subtitle}>
					From easy money management, to{"\n"}travel perks and investments.
				</Text>
			</View>
			<CreditCard />
		...
		<View style={styles.squareGrid}>
			{Array.from({ length: 8 }).map((_, i) => (
				<View
					...
					style={[styles.gridLine, styles.horizontalLine, { top: i * 120 }]}
				/>
			))}
			{Array.from({ length: 8 }).map((_, i) => (
				<View
					...
					style={[styles.gridLine, styles.verticalLine, { left: i * 120 }]}
				/>
			))}
		</View>
	);
